...
export const experiencia: Article[] = [
    {
        ...
        description: 'Coordinación con el personal técnico las actividades a realizar para el levantamiento de información y reparación de averías.\\nElaboración de macros (usando VBA-Excel) para automatizar la elaboración de entregables de FTTH, planos, reportes fotográficos, entre otros.'
    },
    {
...
export const projects: Project[] = [
    {
        ...
        description: 'Proyecto Fullstack de un e-commerce para generar un mejor alcance al público objetivo así como un panel de administración de la tienda.',
        technologies: ['NextJS', 'Nodejs', 'Docker'],
    },
    {
        title: 'Smart Campus UNI',
        description: 'Proyecto colaborativo desarrollado en React del cuál soy partícipe.\\nRealicé las siguientes actividades:\\nMigración del código a Typescript\\nOptimización del código\\nMantenimiento',
        technologies: ['Typescript', 'React', 'Github'],
    },
    {
        title: 'Local',
        description: 'Landing Page del emprendimiento Local (servicio de diseño interior).',
